      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-24 px-6 sm:px-10 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-3 bg-blue-900 text-white px-8 py-3 rounded-full text-lg font-semibold mb-6 shadow-lg">
              <GraduationCap className="w-6 h-6" />
              Distinguished Faculty
            </div>
            <h2 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-blue-900">
              Meet Our Educators
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {facultyList.map((faculty, index) => (
              <div
                key={index}
                className="group bg-white rounded-3xl  shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-blue-600  overflow-hidden relative"
              >
    ...
    <div className="border-t border-gray-100 pt-4 w-full group-hover:border-gray-200 transition-colors duration-300">
      <p className="text-gray-600 text-sm text-center leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
        ...
        <div className="mt-32 relative">
          <div className="bg-blue-900 rounded-3xl p-16 text-white text-center shadow-2xl overflow-hidden relative">
